...
start "VTOL BACKEND - COM22:8765" cmd /k "cd /d "%SCRIPT_DIR%BACKEND" && echo ======================================== && echo    VTOL SCOUT BACKEND && echo    COM22 @ 57600 baud && echo    WebSocket: ws://localhost:8765 && echo ======================================== && echo. && python vtol_backend.py"
...
start "DELIVERY BACKEND - COM17:8766" cmd /k "cd /d "%SCRIPT_DIR%BACKEND" && echo ======================================== && echo    DELIVERY DRONE BACKEND && echo    COM17 @ 57600 baud && echo    WebSocket: ws://localhost:8766 && echo ======================================== && echo. && python delivery_backend.py"
...
echo ========================================
echo.
echo   Terminal 1: VTOL Backend (COM22)
echo   Terminal 2: Delivery Backend (COM17)
